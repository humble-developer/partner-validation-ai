    ...
    <Card class="relative p-6 bg-white/90 backdrop-blur-xl border border-white/30 shadow-xl rounded-2xl">
      <div class="space-y-6">
        <div class="text-center mb-6">
          <div class="w-10 h-10 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center shadow-lg mx-auto mb-3">
            <Building class="w-5 h-5" />
          </div>
          <h2 class="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-1">Partner Registration</h2>
          <p class="text-gray-600 font-medium text-sm">Register a new business partner for validation</p>
        </div>
        ...
        <form @submit="handleSubmit" class="space-y-6" :class="{ 'opacity-75 pointer-events-none': isSubmitting }">
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <h3 class="text-lg font-bold text-gray-900">Company Details</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="space-y-2">
                ...
                <Input
                  ...
                  class="h-11 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 bg-white/70 backdrop-blur-sm rounded-lg text-sm font-medium placeholder:text-gray-400"
                  required
                />
              </div>
            ...
            <div class="space-y-2">
              ...
              <Textarea
                ...
                class="border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 bg-white/70 backdrop-blur-sm rounded-lg text-sm font-medium placeholder:text-gray-400 min-h-20"
              />
            </div>
          </div>
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div class="space-y-2">
                <label class="text-sm font-semibold text-gray-700">ZIP Code</label>
                <Input
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              <div class="w-8 h-8 bg-purple-50 text-purple-600 rounded-lg flex items-center justify-center shadow-lg">
                <User class="w-4 h-4" />
              </div>
        ...
        <!-- Loading Overlay -->
        <div v-if="isSubmitting" class="absolute inset-0 bg-white/80 backdrop-blur-sm rounded-3xl flex items-center justify-center z-10">
          <div class="text-center">
            <div class="w-16 h-16 bg-purple-50 text-purple-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
              <Loader2 class="w-8 h-8 animate-spin" />
            </div>
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Processing Registration</h3>
            <p class="text-sm text-gray-600 font-medium">AI agents are validating partner information...</p>
